...
to market-clearing
  ...
  set returns sum [ my-sentiment ] of patches / number-of-traders   ;; returns
end
...
@#$#@#$#@
<experiments>
  <experiment name="gSentiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="750"/>
    ...
    <enumeratedValueSet variable="logprice-range">
      <value value="0"/>
    </enumeratedValueSet>
  ...
  <experiment name="Log Price Sensitivity" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
  ...
  <experiment name="Long Run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
